<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['detector:result:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['detector:result:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['detector:result:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['detector:result:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="resultList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="成果ID" align="center" prop="resultId" />
      <el-table-column label="成果名称" align="center" prop="resultName" />
      <el-table-column label="成果内容" align="center" prop="resultContent" />
...
<script>
import { listResult, getResult, delResult, addResult, updateResult } from "@/api/detector/result"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除科研成果编号为"' + resultIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('detector/result/export', {
        ...this.queryParams
